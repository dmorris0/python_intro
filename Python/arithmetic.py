...
if __name__ == "__main__":
    ...
    #    In this case all the classes / functions above are defined, and then the code below is also executed.
    #    This is convenient for testing and debugging functions defined above.  In this case call the following from the command line:
